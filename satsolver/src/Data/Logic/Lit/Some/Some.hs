module Data.Logic.Lit.Some.Some (
  -- * Testing
  negLit1, posLit1
, negLit2, posLit2
, negLit3, posLit3
...
, negLitEvtA, posLitEvtA
, negLitEvtB, posLitEvtB
, negLitEvtC, posLitEvtC
) where

  import qualified Data.Logic.Lit.Lit      as Lit
  import qualified Data.Logic.Var.Some.Some as Var.Some
